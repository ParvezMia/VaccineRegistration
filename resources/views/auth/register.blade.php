    ...
    <div class="flex justify-center items-center min-h-screen">
        <div class="bg-white p-8 rounded shadow-md w-1/2">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <!-- Name -->
                <div class="mb-4">
                    <label for="name" class="block text-gray-600 text-sm font-medium mb-2">Name <span
                ...
                <!-- Email -->
                <div class="mb-4">
                    <label for="email" class="block text-gray-600 text-sm font-medium mb-2">Email <span
                            class="text-red-500">*</span></label>
                ...
                <!-- NID -->
                <div class="mb-4">
                    <label for="nid" class="block text-gray-600 text-sm font-medium mb-2">NID <span
                            class="text-red-500">*</span></label>
                ...
                <div class="mb-4">
                    <label for="center" class="block text-gray-600 text-sm font-medium mb-2">Center <span
                            class="text-red-500">*</span></label>
